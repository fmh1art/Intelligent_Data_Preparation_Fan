> 历史版本：当前已改为两张平面分枝图，见[生成与审校说明](flat_research_trees.md)。下文记录v4，不描述当前排版。

# 双树总览图：分类分支与年代审校

2026-09-10版本采用[v4](../fig00_two_research_trees_v4.png)，置于《数据准备与语言模型的交叉前沿》引言后的第2页。正文、图注及读图说明为中文，图内标签为英文。
