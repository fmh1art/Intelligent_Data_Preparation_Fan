...
- 正文8161个汉字，含章节标题和图注。AI4DP为2444字，DP4AI为2494字，具身部分1444字。
...
- 已查看源图及两图上下排列的竖向页面。`dp4ai.pdf`原文件的RoboMIND 2.0/DROID标签存在边框与文字重叠，“Model collaps”缺少末尾的e；此次插入保留原文件，不将这些源图问题记为排版修复。
