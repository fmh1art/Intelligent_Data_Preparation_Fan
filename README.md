...
本项目为可直接在 Overleaf 编译的中文综述。以用户上传的《04 数据准备与语言模型交叉技术的研究进展与发展趋势 - 编辑提问回答.docx》为底稿，将正文凝练至8161个汉字，以语言模型为重点，围绕“基于人工智能的数据准备”（AI4DP）和“面向人工智能的数据准备”（DP4AI）梳理研究，补充具身数据准备及近期进展。
...
两条主线分别为2444字和2494字，具身部分1444字，涵盖跨机器人数据融合、时空对齐、分层标注、失败轨迹、仿真与评测。正文计数包含章节标题和图注，不含参考文献、作者简介、图内文字、标点及英文单词。无摘要、关键词、公式及技术表格，文末沿用范梅浩、范举的照片和简介。
