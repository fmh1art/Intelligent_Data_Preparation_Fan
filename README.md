...
本项目为可直接在 Overleaf 编译的中文综述。以用户上传的《04 数据准备与语言模型交叉技术的研究进展与发展趋势 - 编辑提问回答.docx》为底稿，将正文凝练至8183个汉字，以语言模型为重点，围绕“基于人工智能的数据准备”（AI4DP）和“面向人工智能的数据准备”（DP4AI）梳理研究，补充具身数据准备及近期进展。
...
- [统一术语与图内分支的中文映射](figures/TERMINOLOGY_ZH.md)
