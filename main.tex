...
\usepackage{graphicx,xcolor,caption,fancyhdr,needspace,placeins,pdflscape}
...
\renewbibmacro*{finentry}{\setunit{\addspace}\printfield{note}\finentry}
\usepackage[unicode,hidelinks,pdfauthor={范梅浩；范举},pdftitle={数据准备与语言模型的交叉前沿}]{hyperref}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small 数据准备与语言模型的交叉前沿}
\fancyhead[R]{\small 范梅浩，范举}
\fancyfoot[C]{\small\thepage}
\renewcommand{\headrulewidth}{0.4pt}
\newcommand{\articlefigure}[3]{%
\begin{figure}[htbp]
\centering
\includegraphics[width=0.72\linewidth]{figures/original/#1.pdf}
\caption{#2}\label{#3}
\end{figure}}
\begin{document}
\thispagestyle{plain}
\begin{center}
{\fontsize{20pt}{27pt}\selectfont\bfseries 数据准备与语言模型的交叉前沿\par}
\vspace{11pt}
{\large 范梅浩\quad 范举\par}
\vspace{5pt}
